...
class Producto
{
    ...
    public function getHtml(){
      ...
      $str .= "<img class='center-block img-responsive img-thumbnail' src='./basededatos/img/600_" . $this->foto . "' alt=''>";
    	...
    	$str .= "</div>";
    	$str .= "<h4 style='position:absolute; bottom:4px; left:4px'>". $this->getHtmlPrecio() . "</h4>";
    ...
    public function getHtmlPopup(){
      ...
      $str =  "<h2 class='subtitle text-center' style='margin:0'>" . $this->nombre ."</h2>";
      $str .= "<img class='center-block img-responsive img-thumbnail' src='./basededatos/img/600_" . $this->foto . "' alt=''>";
    	$str .= "<div class='caption'>";
    	$str .= "<p class='text-center'>" . $this->descripcion . "</p>";
    	$str .= "</div>";
      return $str;
    ...
    public function getThumbnailHtml(){
      ...
      $str = "<div class='col-sm-4 col-lg-4 col-md-4'>";
        $str .= "<div class='thumbnail' style='position:relative'>";
          ...
          $str .= "<a href='./carro.php?action=add&id=" . $this->id . "&cantidad=1&redirect=". urlencode(str_replace("state=exclusive","state=normal",$_SERVER["REQUEST_URI"])) ."' class='btn btn-danger'>Comprar</a>";
        $str .= "</div>";
      $str .= "</div>";
      return $str;
